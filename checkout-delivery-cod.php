...
<?php
    if(is_ph()):
        $content = array(
            'static' => array(
                'breadcrumb_1' => 'Delivery Details',
                'header_title' => 'Delivery Details',
                'sub_header' => 'You chose Deliver Later. Complete your information 
                                    here to proceed to checkout.',
                'process_1' => 'Order information',
                'process_1_cutleries_label' => 'Do you need cutleries?',
                'process_1_fullname_label' => 'recipient’s full name',
                'process_1_fullname_placeholder' => 'Full Name',
                'process_1_mobile_no_label' => 'Recipient’s Mobile No.',
                'process_1_delivery_address_label' => 'DELIVERY ADDRESS',
                'process_1_delivery_address_value' => '1234 Jasmine Street, Tahanan Village, Paranaque City, Metro Manila',
                ...
                'process_3' => 'Payment',
                'process_3_paymentselection_label' => 'Please select preferred payment method to pay your bills.',
                'process_3_cash_payment' => 'Pay cash on-the-spot to our delivery personnel when you receive your order.',
                'process_3_change_for_label' => 'CHANGE FOR',
                'process_3_change_for_placeholder' => 'e.g. P 1000',
                'process_3_credit_pay' => 'Pay using your VISA or Mastercard credit card on-the-spot. Our delivery 
                                    personnel will swipe your credit credit to a wireless card terminal.',
                ...
                'service_charge_label' => 'Delivery/Service Charge',
            ...
            'buttons' => array(
                ...
                'cash_pay_btn' => 'CASH PAYMENT UPON DELIVERY',
                'credit_pay_btn' => 'CREDIT CARD PAYMENT UPON DELIVERY',
                'placeorder_btn' => 'PLACE ORDER',
            ),
            'images' => array(
                'home_img' => 'ic_home.svg',
                'pesopay_img' => 'dist/images/checkout/peso-pay.png',
                'card_visa' => 'dist/images/checkout/card-visa.png',
                'master_card' => 'dist/images/checkout/card-mastercard.png',
            ),
        );
    endif;
    ...
    if(is_max()):
        $content = array(
            'static' => array(
                ...
                'breadcrumb_2' => 'Delivery Details',
                'header_title' => 'Delivery Details',
                'sub_header' => 'You chose Deliver Later. Complete your information 
                                    here to proceed to checkout.',
                'process_1' => 'Order information',
                'process_1_cutleries_label' => 'Do you need cutleries?',
                'process_1_contactless_label' => 'Contactless delivery?',
                'process_1_fullname_label' => 'Recipient’s Full Name',
                'process_1_fullname_placeholder' => 'Full Name',
                'process_1_mobile_no_label' => 'Recipient’s Mobile No.',
                'process_1_delivery_address_label' => 'Delivery Address',
                ...
                'process_1_datetime_value' => 'Tuesday, February 23, 2021 7:15 PM',
                'process_1_instructions_label' => 'Special instructions',
                'process_1_instructions_value' => 'Please meet me at the lobby, kuya delivery. Thank you!',
                'process_2' => 'Billing Information',
                'process_2_name' => 'Albert Flores',
                'process_2_email' => 'aflores@gmail.com',
                'process_2_number' => '+63 917 123 4567',
                ...
                'process_3_cash_payment' => 'Pay cash on-the-spot to our delivery personnel when you receive your order.',
                'process_3_change_for_label' => 'Change for',
                'process_3_change_for_placeholder' => 'e,g. ₱ 1,000',
                'process_3_credit_pay' => 'Pay using your VISA or Mastercard credit card on-the-spot. Our delivery 
                                    personnel will swipe your credit credit to a wireless card terminal.',
                'process_3_savecredit_label' => 'Save credit card information to PesoPay',
                'process_3_label1' => 'This secure online payment service is powered by:',
                ...
                'process_3_label2_mb' => 'Placing order means you agree to the',
                'process_3_label3_tb' => 'Terms and Conditions',
                'process_3_label3_mb' => 'Terms and Conditions',
                'process_3_label4_tb' => 'and',
                'process_3_label4_mb' => 'and',
                'process_3_label5_tb' => 'Privacy Policy.',
...
<div class="main-wrapper">
    <section class="c-standard-layout c-checkout c-checkout-delivery <?= is_max() ? 'c-standard-layout-max c-standard-layout-max--delivery' : null; ?>">
            ...
            <div class="c-standard-layout-content">
                ...
                <div class="c-standard-layout-content_display [ u-df-mb ]">
                    <div class="c-checkout-form">
                        ...
                        <form action="" class="o-form-timeline" validation="true" data-form-catcher="deliveryCheckoutForm">
                            <!-- please change input name based on your codebase -->
                            <input type="hidden" data-checker="total-price" value="885.50">
                            <div class="o-form-group [ u-df-mb u-df-mb-w ]">
                                ...
                                <?php if(is_max()):?>
                                    <div class="o-form-group-inner for-cutleries">
                                    <label for="" class="label-sm"><?= $content['static']['process_1_contactless_label']; ?></label>
                                    <div class="o-form-panels [ u-df-mb u-df-mb-w ]">
                                        <input type="hidden" name="contactless" class="o-form-group_input" autocomplete="off" readonly>
                                        <div class="o-form-panels_card">
                                            <div class="o-form-panels_card--detail pad-l-lg [ u-df-mb u-df-mb-ai-c ]" data-trigger-panel="contactless" data-panel-value="yes">
                                                <div class="o-form-panels_card--detail__title">
                                                    <h3 class="h3">Yes</h3>
                                                </div>
                                            </div>
                                        ...
                                        <div class="o-form-panels_card">
                                            <div class="o-form-panels_card--detail [ u-df-mb u-df-mb-ai-c ]" data-trigger-panel="contactless" data-panel-value="no">
                                                <div class="o-form-panels_card--detail__title">
                                                    <h3 class="h3">No</h3>
                                                </div>
                                            </div>
                                ...
                                <div class="o-form-group-inner">
                                    <label for="">
                                        <?= $content['static']['process_1_fullname_label']; ?>
                                        <span class="required">*</span>
                                    </label>
                                    <div class="o-form-group_standard">
                                        <input type="text" name="fullName" class="o-form-group_input" placeholder="<?= $content['static']['process_1_fullname_placeholder']; ?>" data-listen="input" autocomplete="off" >
                                    </div>
                                </div>
                                <div class="o-form-group-inner">
                                    <label for="">
                                        <?= $content['static']['process_1_mobile_no_label']; ?>
                                        <span class="required">*</span>
                                    </label>
                                    <div class="o-form-group_standard o-form-group_phone">
                                        ...
                                        <input type="text" name="mobileNo" class="o-form-group_input" data-listen="input" autocomplete="off" onkeypress="return isNumberKey(event)">
                                    </div>
                                </div>
                                <div class="o-form-group-inner for-description">
                                    <label for="" class="[ u-df-mb-ai-c u-df-mb-jc-sb ]">
                                        <span class="<?php if(is_max()):?>for-delivery<?php endif;?>"><?= $content['static']['process_1_delivery_address_label']; ?></span>
                                        <?php if(is_max()):?>
                                    ...
                                    <span><?= $content['static']['process_1_delivery_address_value']; ?></span>
                                </div>
                                <div class="o-form-group-inner for-description">
                                ...
                                <div class="o-form-group-inner for-description">
                                    ...
                                    <span class="<?php if(is_max()):?>for-instructions<?php endif;?>"><?= $content['static']['process_1_instructions_value']; ?></span>
                                </div>
                            </div>
                            <div class="o-form-group [ u-df-mb u-df-mb-w ]">
                            ...
                            <div class="o-form-group for-payment for-payment-delivery [ u-df-mb u-df-mb-w ]">
                                <span class="o-form-timeline_count [ u-df-mb u-df-mb-ai-c u-df-mb-jc-c ]">3</span>
                                <label for=""><?= $content['static']['process_3']; ?></label>
                                <div class="o-form-group-inner">
                                    <span class="[ u-dnc-mb u-dbc-tb ]"><?= $content['static']['process_3_paymentselection_label']; ?>.</span>
                                    <div class="o-form-panels for-lg-borders [ u-df-mb u-df-mb-w ]">
                                        <input type="hidden" name="payment" class="o-form-group_input" autocomplete="off" readonly>
                                        <div class="o-form-panels_card">
                                            <div class="o-form-panels_card--detail pad-l-lg [ u-df-mb u-df-mb-ai-c ] active" data-trigger-panel="payment" data-panel-value="cpud">
                                                <div class="o-form-panels_card--detail__title">
                                                    <h3 class="h3"><?= $content['buttons']['cash_pay_btn']; ?></h3>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="o-form-panels_card">
                                            <div class="o-form-panels_card--detail pad-l-lg [ u-df-mb u-df-mb-ai-c ]" data-trigger-panel="payment" data-panel-value="ccpud">
                                                <div class="o-form-panels_card--detail__title">
                                                    <h3 class="h3"><?= $content['buttons']['credit_pay_btn']; ?></h3>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="o-form-panels_card">
                                            <div class="o-form-panels_card--detail [ u-df-mb u-df-mb-ai-c ]" data-trigger-panel="payment" data-panel-value="opcc">
                                                <div class="o-form-panels_card--detail__title">
                                ...
                                <div class="o-form-group-inner for-payment-filter active" data-catcher-payment="cpud">
                                    <span><?= $content['static']['process_3_cash_payment']; ?></span>
                                    <label for="">
                                        <?= $content['static']['process_3_change_for_label']; ?>
                                        <span class="required">*</span>
                                    </label>
                                    <div class="o-form-group_standard">
                                        <input
                                            type="text"
                                            name="change"
                                            class="o-form-group_input"
                                            placeholder="<?= $content['static']['process_3_change_for_placeholder']; ?>"
                                            data-listen="input"
                                            autocomplete="off"
                                            data-catcher="payment-change"
                                            onkeypress="return isNumberKey(event)"
                                        >
                                    </div>
                                </div>
                                <div class="o-form-group-inner for-payment-filter" data-catcher-payment="ccpud">
                                    <span>
                                        <?= $content['static']['process_3_credit_pay']; ?>
                                    </span>
                                    <div class="for-credit-cards [ u-df-mb ]">
                                        <a href="#">
                                            <figure>
                                                <img src="<?= $content['images']['card_visa']; ?>" alt="">
                                            </figure>
                                        </a>
                                        <a href="#">
                                            <figure>
                                                <img src="<?= $content['images']['master_card']; ?>" alt="">
                                            </figure>
                                        </a>
                                    </div>
                                </div>
                                <div class="o-form-group-inner for-payment-filter" data-catcher-payment="opcc">
                                ...
                                <div class="o-form-group-inner">
                                    ...
                                    <div class="for-terms [ u-dnc-tb u-dbc-mb ]">
                                        ...
                                        <?= $content['static']['process_3_label2_mb']; ?> <br/>
                                            <a href="" data-trigger-modal="condition-of-use" ><?= $content['static']['process_3_label3_mb']; ?></a>
                                            <?= $content['static']['process_3_label4_mb']; ?>
                            ...
                            <button type="submit" class="o-button o-button-lg for-cod">
