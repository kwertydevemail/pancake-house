<?php
    $content = array(
        'static' => array(
                'header_title' => 'Squad Stuff XXL',
                'content_display' => 'Squad Stuff XXL includes an 18" NY-Style Original 
                                        Crust Classic Pizza, three 1/2-pound wings (choose up 
                                        to four flavors), three large pastas two one 1.5L sodas. 
                                        Good for 8 to 10 people.',
                'detail_content' => 'Add P140 to upgrade to Signature or Legendary pizza.<br>
                                        Per DTI Fair Trade Permit No. FTEB-109188 Series of 2020 ',
        ...
        'images' => array(
            'bundle_img_sm' => 'Bundle XXL.png',
            'bundle_img_lg' => 'Bundle XXL.png',
        ),
    );
    $process_2_products = [
        [
...
?>
<section class="c-bundle-xxl">
    <div class="o-container">
        <div class="c-bundle-xxl-content [ u-df-mb u-df-mb-fd-c u-df-tb-fd-r ]">
            <h3 class="o-header-title-slant"><?= $content['static']['header_title']; ?></h3>
            <div class="c-bundle-xxl-content_display">
                <p>
            ...
            <div class="c-bundle-xxl-content_form">
                <h3 class="o-header-title"><?= $content['static']['right_header_title']; ?></h3>
                <span></span>
                <div class="c-bundle-xxl-content_form--details">
                    ...
                    <div class="o-form-group o-form-dropdown">
                            ...
                            <div class="o-form-dropdown_input">
                                ...
                                <ul class="[ u-df-mb u-df-mb-fd-c ]">
                                    <li class="[ u-df-mb ]" data-select-value="Pepperoni - 18&quot;" data-price-value="">
                                        <figure>
                                    ...
                                    <li class="[ u-df-mb ]" data-select-value="Hawaiian - 18&quot;" data-price-value="">
                                        <figure>
                                    ...
                                    <li class="[ u-df-mb ]" data-select-value="Patty Melt - 18&quot;" data-price-value="">
                                        <figure>
                                    ...
                                    <li class="[ u-df-mb ]" data-select-value="Roasted Garlic & Shrimp - 18&quot;" data-price-value="">
                                        <figure>
                                    ...
                                    <li class="[ u-df-mb ]" data-select-value="#4 Cheese - 18&quot;" data-price-value="">
                                        <figure>
                                    ...
                                    <li class="[ u-df-mb ]" data-select-value="Manhattan Meatlovers - 18&quot;" data-price-value="">
                                        <figure>
                                    ...
                                    <li class="[ u-df-mb ]" data-select-value="BBQ Chicken - 18&quot;" data-price-value="">
                                        <figure>
                                    ...
                                    <li class="[ u-df-mb ]" data-select-value="Garden Special - 18&quot;" data-price-value="">
                                        <figure>
                                    ...
                                    <li class="[ u-df-mb ]" data-select-value="New York's Finest - 18&quot;" data-price-value="">
                                        <figure>
                                    ...
                                    <li class="[ u-df-mb ]" data-select-value="Four Seasons Original - 18&quot;" data-price-value="">
                                        <figure>
                                    ...
                                    <li class="[ u-df-mb ]" data-select-value="Four Seasons All Meat - 18&quot;" data-price-value="">
                                        <figure>
                        ...
                        <div class="o-form-group o-form-dropdown c-bundle-xxl-content_form--details__multi custom-padding-bottom">
                        ...
                        <div class="o-form-group o-form-dropdown c-bundle-xxl-content_form--details__multi custom-padding-bottom">
                            ...
                            <div class="o-form-dropdown_input">
                                <input type="text" name="pasta3" class="o-form-group_input" placeholder="<?= $content['static']['process_3_placeholder']; ?>" data-listen="input" autocomplete="off" data-required-validate="true" readonly>
                                <ul class="[ u-df-mb u-df-mb-fd-c ]">
                                    <?php foreach($process_3_products as $key => $value): ?>
                                        <li class="[ u-df-mb ]" data-select-value="<?= $value['value'] ?>" data-price-value="<?= $value['price_value'] ?>">
                                            <figure>
                        ...
                        <div class="o-form-group o-form-dropdown c-bundle-xxl-content_form--details__multi last-padding">
                            ...
                            <div class="o-form-dropdown_input last-margin">
                                <input type="text" name="drinks2" class="o-form-group_input" placeholder="<?= $content['static']['process_4_placeholder']; ?>" data-listen="input" autocomplete="off" data-required-validate="true" readonly>
                                <ul class="[ u-df-mb u-df-mb-fd-c ]">
                                    <?php foreach($process_4_products as $key => $value): ?>
                                        <li class="[ u-df-mb ]" data-select-value="<?= $value['value'] ?>" data-price-value="<?= $value['price_value'] ?>">
                                            <figure>
                        ...
                        <div class="order-summary" data-summary="order">
                            ...
                            <ul class="order-summary-list">
                                ...
                                <li data-catcher="pasta3"></li>
                                <li data-catcher="drinks1"></li>
                                <li data-catcher="drinks2"></li>
                            </ul>
