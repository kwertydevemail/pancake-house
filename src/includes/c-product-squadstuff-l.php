<?php
    $content = array(
        'static' => array(
                'header_title' => 'Squad Stuff L',
                'content_display' => 'Squad Stuff L includes a 12" NY-Style Original Crust Classic Pizza, 
                                        1/2-pound wings (choose up to four flavors), large pasta and one 
                                        1.5L soda. Good for 3 to 4 people.',
                'detail_content' => 'Upgrade pizza to Signature or Legendary: Add P 90',
        ...
        'images' => array(
            'bundle_img_sm' => 'Bundle L.png',
            'bundle_img_lg' => 'Bundle L.png',
        ),
    );
    $process_1_products = [
        [
        ...
        [
            'value' => 'Patty Melt - 12&quot;',
            'price_value' => '',
            'img_link' => 'dist/images/product/pizza-3.png',
            'name' => 'Patty Melt',
            'others' => ['<span>Upgrade</span>', '<span>Add P 90.00</span>']
        ],
        [
            'value' => 'Roasted Garlic & Shrimp - 12&quot;',
            'price_value' => '',
            'img_link' => 'dist/images/product/pizza-4.png',
        ...
        [
            'value' => '#4 Cheese - 12&quot;',
            'price_value' => '',
            'img_link' => 'dist/images/product/pizza-5.png',
            'name' => '#4 Cheese',
            'others' => ['<span>Upgrade</span>', '<span>Add P 90.00</span>']
        ],
        [
            'value' => 'Manhattan Meatlovers - 12&quot;',
            'price_value' => '',
            'img_link' => 'dist/images/product/pizza-6.png',
            'name' => 'Manhattan Meatlovers',
            'others' => ['<span>Upgrade</span>', '<span>Add P 90.00</span>']
        ],
        [
            'value' => 'BBQ Chicken - 12&quot;',
            'price_value' => '',
            'img_link' => 'dist/images/product/pizza-7.png',
            'name' => 'BBQ Chicken',
            'others' => ['<span>Upgrade</span>', '<span>Add P 90.00</span>']
        ],
        [
            'value' => 'Garden Special - 12&quot;',
            'price_value' => '',
            'img_link' => 'dist/images/product/pizza-8.png',
            'name' => 'Garden Special',
            'others' => ['<span>Upgrade</span>', '<span>Add P 90.00</span>']
        ],
        [
            'value' => 'New York&#39;s Finest - 12&quot;',
            'price_value' => '',
            'img_link' => 'dist/images/product/pizza-9.png',
            'name' => 'New York&#39;s Finest',
            'others' => ['<span>Upgrade</span>', '<span>Add P 90.00</span>']
        ],
        [
            'value' => 'Four Seasons Original - 12&quot;',
            'price_value' => '',
            'img_link' => 'dist/images/product/pizza-10.png',
            'name' => 'Four Seasons Original',
            'others' => ['<span>Upgrade</span>', '<span>Add P 90.00</span>']
        ],
        [
            'value' => 'Four Seasons All Meat - 12&quot;',
            'price_value' => '',
            'img_link' => 'dist/images/product/pizza-11.png',
...
?>
<section class="c-bundle-l">
    <div class="o-container">
        <div class="c-bundle-l-content [ u-df-mb u-df-mb-fd-c u-df-tb-fd-r ]">
            <h3 class="o-header-title-slant"><?= $content['static']['header_title']; ?></h3>
            <div class="c-bundle-l-content_display">
                <p>
            ...
            <div class="c-bundle-l-content_form">
                <h3 class="o-header-title"><?= $content['static']['right_header_title']; ?></h3>
                <span></span>
                <div class="c-bundle-l-content_form--details">
                    <form action="" class="o-form-timeline" validation="true" data-form-catcher="addedToCartModal" data-order-summary="order">
                        <div class="o-form-group o-form-dropdown">
                            ...
                            <div class="o-form-dropdown_input">
                                ...
                                <ul class="[ u-df-mb u-df-mb-fd-c ]">
                                    <!-- <?php foreach($process_1_products as $key => $value): ?>
                                        <li class="[ u-df-mb ]" data-select-value="<?= $value['value'] ?>" data-price-value="<?= $value['price_value'] ?>">
                                            ...
                                            <div class="o-form-dropdown_input--item [ u-df-mb u-df-mb-fd-c u-df-mb-jc-c ]">
                                                ...
                                                <div class="o-form-dropdown_input--item__subdetail-single [ u-df-mb ]">
                                                    <?php foreach($value['others'] as $key => $val): ?>
                                                        <?= $val ?>
                                                    <?php endforeach; ?>
                                                </div>
                                            </div>
                                    ...
                                    <?php endforeach; ?> -->
                                    <li class="[ u-df-mb ]" data-select-value="Pepperoni - 12&quot;" data-price-value="">
                                        <figure>
                                    ...
                                    <li class="[ u-df-mb ]" data-select-value="Hawaiian - 12&quot;" data-price-value="">
                                        <figure>
                                    ...
                                    <li class="[ u-df-mb ]" data-select-value="Patty Melt - 12&quot;" data-price-value="">
                                        <figure>
                                    ...
                                    <li class="[ u-df-mb ]" data-select-value="Roasted Garlic & Shrimp - 12&quot;" data-price-value="">
                                        <figure>
                                    ...
                                    <li class="[ u-df-mb ]" data-select-value="#4 Cheese - 12&quot;" data-price-value="">
                                        <figure>
                                    ...
                                    <li class="[ u-df-mb ]" data-select-value="Manhattan Meatlovers - 12&quot;" data-price-value="">
                                        <figure>
                                    ...
                                    <li class="[ u-df-mb ]" data-select-value="BBQ Chicken - 12&quot;" data-price-value="">
                                        <figure>
                                    ...
                                    <li class="[ u-df-mb ]" data-select-value="Garden Special - 12&quot;" data-price-value="">
                                        <figure>
                                    ...
                                    <li class="[ u-df-mb ]" data-select-value="New York's Finest - 12&quot;" data-price-value="">
                                        <figure>
                                    ...
                                    <li class="[ u-df-mb ]" data-select-value="Four Seasons Original - 12&quot;" data-price-value="">
                                        <figure>
                                    ...
                                    <li class="[ u-df-mb ]" data-select-value="Four Seasons All Meat - 12&quot;" data-price-value="">
                                        <figure>
                        ...
                        <div class="o-form-group o-form-dropdown c-bundle-l-content_form--details__multi custom-padding-bottom">
