    ...
    if(is_ph()):
        $content = array(
            ...
            'buttons' => array(
                ...
                'proceed' => 'Proceed',
                'view_saved_address' => 'VIEW SAVED ADDRESSES'
            ...
            <div class="c-standard-layout-content">
                ...
                <div class="c-standard-layout-content_display [ u-df-mb u-df-mb-w ]">
                    ...
                    <form action="" class="o-form-timeline" validation="true" data-form-catcher="orderDeliveryForm">
                        <div class="o-form-group o-form-dropdown o-form-address-picker">
                            <span class="o-form-timeline_count [ u-df-mb u-df-mb-ai-c u-df-mb-jc-c ]">1</span>
                            <label for=""><?= $content['static']['process-1']; ?></label>
                            <div class="c-ordernow-cta">
                                <a href="" class="o-button o-button-lg o-button-trans o-button-bordered">
                                    <span><?= $content['buttons']['view_saved_address']; ?></span>
                                </a>
                            </div>
                            <div class="o-form-dropdown_input">
                                <textarea name="address"  class="o-form-group_input" placeholder="<?= $content['static']['newaddress-placeholder']; ?>" data-listen="input" autocomplete="off" data-required-validate="true" data-address-filter="search"></textarea>
                                ...
                                <ul class="[ u-df-mb u-df-mb-fd-c ]" data-address-catcher="search">
                                        <?php foreach($addressOption as $key => $value): ?>
                        ...
                        <div class="o-form-group for-house-detail">
                            ...
                            <div class="o-form-group_standard">
                                <input type="text" name="unit" class="o-form-group_input [ u-dbc-tb u-dnc-mb ]" placeholder="<?= $content['static']['process-2-placeholder-dt']; ?>" data-listen="input" autocomplete="off" data-required-validate="true">
                            </div>
                        </div>
