    ...
    if(is_ph()):
        $content = array(
            'static' => array(
                ...
                'sub_header' => 'You chose pick-up inside the store. Complete your 
    ...
    if(is_max()):
        $content = array(
            'static' => array(
                ...
                'right_section_title2' => 'Order Summary',
                'subtotal_label' => 'Subtotal',
                'subtotal_value' => '₱ 2,416.00',
                'service_charge_label' => 'Service Charge',
                'service_charge_value' => '₱ 80.50',
                'total_label' => 'Total',
                'total_value' => '₱ 2,496.50',
            ),
            'buttons' => array(
                'back' => 'Back to Home',
                'edit_btn' => 'EDIT',
            ...
            <div class="c-standard-layout-content">
                ...
                <div class="c-standard-layout-content_display [ u-df-mb ]">
                    <div class="c-checkout-form">
                        ...
                        <form action="" class="o-form-timeline" validation="true">
                            <div class="o-form-group [ u-df-mb u-df-mb-w ]">
                                ...
                                <div class="o-form-group-inner <?php if(is_ph()):?>with-phone-drop<?php endif;?>">
                                    <label for="">
                                    ...
                                    <?php if(is_ph()):?>
                                        <div class="o-form-group_phone">
                                            <div class="o-form-dropdown_input" data-catcher-filter="holder">
                                                <input type="text" name="mobileNoPre" class="o-form-group_input" placeholder="+63" data-listen="input" autocomplete="off" data-field-filter="prefix-number" onkeypress="return isNumberKey(event)">
                                                <ul class="[ u-df-mb u-df-mb-fd-c ]" >
                                                    <li class="[ u-df-mb ]" data-select-value="+63">
                                                        <div class="o-form-dropdown_input--item [ u-df-mb u-df-mb-fd-c u-df-mb-jc-c ]">
                                                            <h5 class="h5">+63</h5>
                                                        </div>
                                                    </li>
                                                    <li class="[ u-df-mb ]" data-select-value="+65">
                                                        <div class="o-form-dropdown_input--item [ u-df-mb u-df-mb-fd-c u-df-mb-jc-c ]">
                                                            <h5 class="h5">+65</h5>
                                                        </div>
                                                    </li>
                                                    <li class="[ u-df-mb ]" data-select-value="+01">
                                                        <div class="o-form-dropdown_input--item [ u-df-mb u-df-mb-fd-c u-df-mb-jc-c ]">
                                                            <h5 class="h5">+01</h5>
                                                        </div>
                                                    </li>
                                                    <li class="[ u-df-mb ]" data-select-value="+938">
                                                        <div class="o-form-dropdown_input--item [ u-df-mb u-df-mb-fd-c u-df-mb-jc-c ]">
                                                            <h5 class="h5">+938</h5>
                                                        </div>
                                                    </li>
                                        ...
                                        <div class="o-form-group_standard">
                                            <input type="text" name="mobileNo" class="o-form-group_input" data-listen="input" autocomplete="off" data-validate="number" data-required-validate="true" >
                                        </div>
                                    <?php endif;?>
                                </div>
                            ...
                            <div class="o-form-group for-payment [ u-df-mb u-df-mb-w ]">
                                ...
                                <div class="o-form-group-inner">
                                    <div class="o-form-panels [ u-df-mb u-df-mb-w ]">
                                        ...
                                        <div class="o-form-panels_card">
                                            <div class="o-form-panels_card--detail pad-l-lg [ u-df-mb u-df-mb-ai-c ] <?php if(is_max()):?>only active<?php endif;?>" data-trigger-panel="payment" data-panel-value="opcc">
                                                <div class="o-form-panels_card--detail__title">
                                        ...
                                        <?php if(is_ph()):?>
                                            <div class="o-form-panels_card">
                                                <div class="o-form-panels_card--detail [ u-df-mb u-df-mb-ai-c ]" data-trigger-panel="payment" data-panel-value="cp">
                                                    <div class="o-form-panels_card--detail__title">
                                ...
                                <div class="o-form-group-inner for-payment-filter <?php if(is_max()):?>active<?php endif;?>" data-catcher-payment="opcc">
                                    ...
                                    <div class="for-terms [ u-dnc-tb u-dbc-mb ]">
                                        <span>
                                            ...
                                            <!-- <a href="" data-trigger-modal="privacy-policy" ><?= $content['static']['process_3_label5_mb']; ?></a> -->
                                ...
                                <div class="o-form-group-inner for-payment-filter" data-catcher-payment="cp">
                                </div>
                            </div>
                            <button type="submit" class="o-button o-button-lg for-pickup" data-trigger-modal="invalid-delivery-checkout">
